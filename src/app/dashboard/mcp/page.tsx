      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-foreground-muted text-sm">
            Drive your entire MailPilot account from Claude — mine leads, write sequences, and launch campaigns
      ...
      <section className="rounded-xl border border-border bg-background shadow-sm">
        ...
        <div className="p-4 space-y-4 text-sm">
          ...
          <div className="rounded-lg border border-border bg-background-tertiary/40 p-3 text-xs space-y-1.5">
            ...
            <p className="text-foreground-muted">
              Claude writes every email on <strong>your</strong> Claude plan; MailPilot just sends them — no platform LLM,
              no API key needed.
            </p>
          </div>
        </div>
